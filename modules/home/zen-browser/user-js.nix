  ...
  programs.zen-browser.profiles.default = {
    extraConfig = lib.strings.concatLines (
      [
        ...
        # BetterZen
        (builtins.readFile "${inputs.firefox-betterfox}/zen/user.js")
      ]
      ++ [
        # Overrides
        (toUserJS {
          # Start Page
          "browser.startup.homepage" = "about:home"; # start page is Zen Browser home
          "browser.newtabpage.enabled" = true; # new tab leads to Zen Browser home
